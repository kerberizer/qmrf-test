...
public class DeleteAlert  extends  AbstractAlertUpdate<DBUser>  {
	...
	public String[] getSQL() throws AmbitException {
		...
		if (getObject()!=null && getObject().getID()>0 ) user = DBAlert._fields.iduser.getCondition();
		if (getGroup()!=null && getGroup().getID()>0 ) alert = DBAlert._fields.idquery.getCondition();
