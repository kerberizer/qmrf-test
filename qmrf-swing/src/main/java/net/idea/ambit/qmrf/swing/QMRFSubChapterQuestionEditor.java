...
import net.idea.ambit.qmrf.chapters.QMRFSubChapterQuestion;
...
public class QMRFSubChapterQuestionEditor extends QMRFSubChapterTextEditor implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2214697545445456362L;
	...
	protected JComponent[] createJComponents() {
        ...
        listbox.setSelectedItem(c.getAttribute(c.getQuestion()));
