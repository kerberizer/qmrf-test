...
import net.idea.ambit.qmrf.chapters.QMRFSubChapterDataset;
...
public class QMRFSubChapterDatasetEditor extends QMRFSubChapterTextEditor implements ItemListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 35469037203300639L;
	...
	protected JComponent[] createJComponents() {
		...
		String[] options = ((QMRFSubChapterDataset) chapter).getOptions();
		JCheckBox box  = null;
