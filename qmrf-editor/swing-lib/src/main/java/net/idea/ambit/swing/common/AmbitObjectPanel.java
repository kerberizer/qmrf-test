 ...
 */
public class AmbitObjectPanel<T extends AmbitObject> extends CorePanel implements IAmbitEditor<T>, 
										MouseListener, 
										KeyListener, PropertyChangeListener,
										ListSelectionListener,
										IAmbitObjectListener<T>,
										IAmbitListListener<T> {
	protected boolean editable = true;
	protected T ao = null;
	protected TreeMap labels, edits;
	protected Stack parents = null;
	
	protected AmbitObjectPanel<T> subpanel = null;
	 ...
	 * @param obj
	 */
	public AmbitObjectPanel(String title, T obj) {
	 ...
	 * @param fClr
	 */
	public AmbitObjectPanel(String title, Color bClr, Color fClr, T obj) {
	...
	public AmbitObjectPanel(String title, Color bClr, Color fClr, T obj, int orientation) {
		super(title, bClr, fClr);
		labels = new TreeMap();
		edits = new TreeMap();		
		this.ao = obj;
    ...
    */
	...
	public void ambitListChanged(AmbitListChanged<T> event) {
		...
		T selectedObject = event.getObject();
    ...
    public void setObject(T object) { setAO(object);};
    @Override
    public T getObject() {
    	return getAO();
    }
