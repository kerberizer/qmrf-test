...
public class CallablePasswordReset extends QMRFCallableUserCreator implements IDBConfig {
	...
	protected IQueryUpdate<? extends Object, DBUser> createUpdate(DBUser user)
			throws Exception {
		if (Method.POST.equals(method)) {
			registration = new QMRFUserRegistration();
			((QMRFUserRegistration)registration).setTitle("Forgotten password");
