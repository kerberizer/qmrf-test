...
public class ReadRegistrationStatus  extends AbstractQuery<DBUser, UserRegistration, EQCondition, UserRegistration>  implements 
IQueryRetrieval<UserRegistration>, IDBConfig {
	...
	public List<QueryParam> getParameters() throws AmbitException {
		...
		if (getFieldname()==null || getFieldname().getUserName()==null) throw new AmbitException("Empty argument!");
